...
async function scrapeMitarbeiterWithLeads(client, cookieString) {
    try {
...
async function countLeadsForMitarbeiter(client, cookieString, mitarbeiterId) {
    try {
...
async function saveLeadsCountToSupabase(vcrNumber, mitarbeiterId, leadsCount) {
    try {
...
router.post('/count-total', async (req, res) => {
